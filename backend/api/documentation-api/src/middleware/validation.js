...
export const validation = {
  ...
  createIdea: [
    ...
    body('category')
      ...
      .withMessage('Category must be one of: new_feature, improvement, bug_fix, content, structure'),
    ...
    body('status')
      ...
      .withMessage('Status must be one of: backlog, todo, in_progress, review, done'),
