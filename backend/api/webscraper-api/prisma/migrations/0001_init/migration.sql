...
-- CreateIndex
CREATE INDEX "idx_scrape_jobs_status" ON "scrape_jobs"("status", "started_at" DESC);

-- CreateIndex
CREATE INDEX "idx_scrape_jobs_status_type_started" ON "scrape_jobs"("status", "type", "started_at" DESC);
...
-- CreateIndex
CREATE INDEX "idx_scrape_jobs_schedule" ON "scrape_jobs"("schedule_id");
...
-- CreateIndex
CREATE INDEX "idx_job_schedules_template" ON "job_schedules"("template_id");

-- CreateIndex
CREATE INDEX "idx_job_schedules_last_run" ON "job_schedules"("last_run_at" DESC);
...
-- CreateIndex
CREATE INDEX "export_jobs_export_type_idx" ON "export_jobs"("export_type");
...
-- AddForeignKey
ALTER TABLE "scrape_jobs" ADD CONSTRAINT "scrape_jobs_schedule_id_fkey" FOREIGN KEY ("schedule_id") REFERENCES "job_schedules"("id") ON DELETE SET NULL ON UPDATE CASCADE;
