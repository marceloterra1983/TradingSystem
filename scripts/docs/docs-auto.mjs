...
function upsertComment(content, label, value) {
  ...
  if (pattern.test(content)) {
    return content.replace(pattern, comment);
  }
  ...
  const tasks = [
    ...
    },
    {
      ...
      run: async () => {
        ...
        updated = upsertComment(updated, 'Source', 'docs/context/ops/service-port-map.md');
        updated = upsertComment(updated, 'Last generated', timestamp);
        updated = upsertComment(updated, 'AUTO-GENERATED SECTIONS by docs:auto - DO NOT EDIT MANUALLY', '');
    ...
    },
    {
      ...
      run: async () => {
        ...
        updated = upsertComment(updated, 'Source', 'frontend/dashboard/tailwind.config.js');
        updated = upsertComment(updated, 'Last generated', timestamp);
        updated = upsertComment(updated, 'AUTO-GENERATED by docs:auto - DO NOT EDIT MANUALLY', '');
        const content = [frontmatter, updated].filter(Boolean).join('\n\n').trimEnd().concat('\n');
        await writeFile(targetPath, content, 'utf8');
      },
    },
