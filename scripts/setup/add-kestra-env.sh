...
echo "" >> "$ENV_FILE"
echo "# Kestra HTTP Ports (using 8180 to avoid conflict with Adminer:8080)" >> "$ENV_FILE"
...
echo "  • KESTRA_HTTP_PORT=8180 (avoiding conflict with Adminer:8080)"
...
echo ""
echo "✅ Kestra will be accessible at: http://localhost:8180"
