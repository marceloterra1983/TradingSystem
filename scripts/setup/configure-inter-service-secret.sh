...
echo ""
echo "Next steps:"
echo "  1. Rebuild Docker images: docker-compose -f tools/compose/docker-compose.rag.yml build"
echo "  2. Restart services: docker-compose -f tools/compose/docker-compose.rag.yml up -d"
