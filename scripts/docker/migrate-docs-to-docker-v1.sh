...
if [[ "$DRY_RUN" == "false" ]]; then
    ...
    docker-compose -f infrastructure/compose/docker-compose.docs.yml build docs-api
    log_success "DocsAPI image built"
    
    log_info "Building Docusaurus production image..."
    docker-compose -f infrastructure/compose/docker-compose.docs.yml build docusaurus
...
if [[ "$DRY_RUN" == "false" ]]; then
    ...
    if [[ $elapsed -ge $timeout ]]; then
        ...
        log_info "Check logs: docker-compose -f infrastructure/compose/docker-compose.docs.yml logs docs-api"
        exit 1
    fi
else
...
echo "  • View logs:    docker-compose -f infrastructure/compose/docker-compose.docs.yml logs -f docs-api"
echo "  • Restart:      docker-compose -f infrastructure/compose/docker-compose.docs.yml restart docs-api"
echo "  • Stop:         docker-compose -f infrastructure/compose/docker-compose.docs.yml down"
...
echo "    docker-compose -f infrastructure/compose/docker-compose.docs.yml --profile production up -d"
echo ""
