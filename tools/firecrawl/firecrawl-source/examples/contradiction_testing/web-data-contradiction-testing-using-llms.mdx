---
title: Build an agent that checks your website for contradictions
sidebar_position: 1
tags: [documentation]
domain: ops
type: guide
summary: Learn how to use Firecrawl and Claude to scrape your website's data and look for contradictions and inconsistencies in a few lines of code. When you a...
status: active
