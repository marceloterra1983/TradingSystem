---
title: Install Firecrawl on a Kubernetes Cluster (Simple Version)
sidebar_position: 1
tags: [documentation]
domain: ops
type: index
summary: 1. Set [secret.yaml](secret.yaml) and [configmap.yaml](configmap.yaml) and do not check in secrets
status: active
