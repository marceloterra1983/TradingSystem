...
- **Score**: 0 (Very Difficult (College graduate))
- **Metrics**: 1159 words, 55 sentences
...
### 4. reference/adrs/ADR-007-env-governance-separation.md

- **Score**: 0 (Very Difficult (College graduate))
- **Metrics**: 1103 words, 181 sentences
- **Avg Words/Sentence**: 6.1
- **Long Sentences**: 9
- **Passive Voice**: 0 occurrences
...
description: "Archite...
- (33 words) env` regularmente, causando perda de customizações locais
- Developer commitam secrets acidentalment...
- (26 words) env`
- Nenhuma fonte é autoritativa

### Impacto Medido
- ~5 horas/semana perdidas em debugging de c...

### 5. reference/adrs/ADR-003-api-gateway-implementation.md
...
### 6. reference/architecture/containerization.md
...
### 7. reference/adrs/rag-services/ADR-002-file-watcher-auto-ingestion.md
...
### 8. reference/adrs/rag-services/ADR-001-redis-caching-strategy.md
...
### 9. tools/security-config/p0-security-implementation.md
...
### 10. tools/rag/integration-guide-rag-crud.md
...
### 11. tools/docker/container-inventory.md
...
### 12. tools/documentation/docusaurus/ports-strategy.md
...
### 13. tools/documentation/docusaurus/quick-commands.md
...
### 14. tools/documentation/docusaurus/deployment-guide.md
...
### 15. tools/runtime/python/bash-vs-venv.md
...
### 16. reports/governance-status.mdx

- **Score**: 0 (Very Difficult (College graduate))
- **Metrics**: 90 words, 4 sentences
- **Avg Words/Sentence**: 22.5
- **Long Sentences**: 1
- **Passive Voice**: 0 occurrences
