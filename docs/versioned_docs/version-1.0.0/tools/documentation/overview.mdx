...
- **Governance & Validation** - Documentation quality standards (see `governance/VALIDATION-GUIDE.md`)
- **Review Checklist** - Documentation review process (see `governance/REVIEW-CHECKLIST.md`)
