...
curl http://localhost:3400/api/v1/docs/status

# Verify Markdown search endpoints
curl "http://localhost:3400/api/v1/docs/facets?q=architecture"
curl "http://localhost:3400/api/v1/docs/suggest?q=arch"
curl "http://localhost:3400/api/v1/docs/search?q=docs&domain=backend&type=guide"
