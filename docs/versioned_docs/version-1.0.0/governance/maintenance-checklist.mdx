...
description: Quarterly hygiene checklist covering automation, audits, and ownership.
...
- [ ] Review version deprecation candidates (> 2 releases old):
  ...
  - See `versioning-guide` for deprecation procedures
...
- [Versioning Guide](https://github.com/marceloterra1983/TradingSystem/blob/main/governance/versioning-guide) - Version management procedures
- [Validation Guide](./validation-guide) - How to run validation suite (includes version validation)
- [Metrics Dashboard Guide](https://github.com/marceloterra1983/TradingSystem/blob/main/governance/metrics-dashboard) - Dashboard usage and metrics explanation
