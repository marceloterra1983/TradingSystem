...
- [Versioning Guide](https://github.com/marceloterra1983/TradingSystem/blob/main/governance/VERSIONING-GUIDE.md) - Version management procedures
- [Validation Guide](./validation-guide) - How to run validation suite (includes version validation)
- [Metrics Dashboard Guide](https://github.com/marceloterra1983/TradingSystem/blob/main/governance/METRICS-DASHBOARD.md) - Dashboard usage and metrics explanation
