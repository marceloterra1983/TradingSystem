...
| Variable | Default | Description |
|----------|---------|-------------|
| `CORS_ORIGIN` | `http://localhost:3103,http://localhost:3400,http://localhost:3401` | Allowed CORS origins (Dashboard + Docs stack) |
...
# CORS (allow Dashboard + Docs stack)
...
```bash
# Allow Dashboard and Docs stack (default)
CORS_ORIGIN=http://localhost:3103,http://localhost:3400,http://localhost:3401
...
for port in 3103 3200 3400 3401 3500 3600 4005 9000 9090; do
  echo -n "Port $port: "
