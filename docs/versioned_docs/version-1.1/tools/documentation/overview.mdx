...
- **Governance & Validation** - Documentation quality standards (see `governance/controls/validation-guide`)
- **Review Checklist** - Documentation review process (see `governance/controls/review-checklist`)
