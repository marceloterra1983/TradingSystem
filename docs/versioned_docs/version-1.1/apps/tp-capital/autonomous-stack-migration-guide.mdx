...
### 1. ADR Completo
**Localização:** `docs/content/reference/adrs/ADR-008-tp-capital-autonomous-stack` (a publicar)
...
**Localização:** `tools/compose/docker-compose.4-1-tp-capital-stack.yml`
...
- ADR-008: TP-Capital Autonomous Stack (em elaboração)
