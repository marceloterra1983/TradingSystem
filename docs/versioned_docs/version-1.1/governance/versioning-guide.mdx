...
sidebar_label: Versioning Guide
sidebar_position: 10
---
...
- [versioning-automation](./versioning-automation) - Automated workflow documentation
...
- [ ] Content review complete (see `review-checklist`)
...
> See [versioning-automation](./versioning-automation) for automated workflow.
...
- [ ] Send email to stakeholders (use `communication-plan` template)
...
- [README.md](https://github.com/marceloterra1983/TradingSystem/blob/main/docs/README.md) - Quick versioning commands
- [validation-guide](./validation-guide) - Validation procedures (includes version validation)
- [versioning-automation](./versioning-automation) - Automated versioning workflow
- [maintenance-checklist](./maintenance-checklist) - Quarterly maintenance tasks
- [communication-plan](./communication-plan) - Announcement templates
