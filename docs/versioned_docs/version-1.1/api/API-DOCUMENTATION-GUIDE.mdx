...
- **Status API (descontinuado)** - Health monitoring and service orchestration (removido do stack)
...
|---------|------|----------|-----------|---------|
| **Workspace API** | 3200 | `/api/workspace` | ✅ Docker | Ideas & docs management |
| **TP Capital** | 4005 | `/api/tp-capital` | ✅ Docker | Trading signals ingestion |
| **Documentation API** | 3401 | `/api/documentation` | ✅ Docker | Docs platform + RAG proxy |
| **Dashboard** | 3103 | `/` | ❌ Host | React frontend |
| **Docs Hub** | 3400 | `/docs` | ✅ Docker | Docusaurus portal |
...
From [ADR-003: API Gateway Implementation](../reference/adrs/ADR-003-api-gateway-implementation):
...
└─────────┘                       └──────┬───────┘
                         ...
                         ┌──────────────────────────┐
                         │ Backend Service          │
                         │ - Trust Kong validation  │
                         │ - Use claims for authz   │
                         └──────────────────────────┘
```
...
**See:** [ADR-003: API Gateway Implementation](../reference/adrs/ADR-003-api-gateway-implementation) - Proposes API versioning strategy
...
```json
{
  ...
  "sources": [
    ...
    {
      "file_path": "governance/planning/TECHNICAL-DEBT-TRACKER.md",
...
**See:** [ADR-005: Test Coverage Strategy](../reference/adrs/ADR-005-test-coverage-strategy) - Comprehensive testing roadmap
...
- [ADR-003: API Gateway Implementation](../reference/adrs/ADR-003-api-gateway-implementation)
- [ADR-005: Test Coverage Strategy](../reference/adrs/ADR-005-test-coverage-strategy)
...
- API versioning (v1 → v2 migration)
