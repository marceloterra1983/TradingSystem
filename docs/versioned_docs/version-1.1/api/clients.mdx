...
- **Workspace API** — pacote em `clients/typescript/workspace-api` (Porta 3200)
- **Documentation API** — pacote em `clients/typescript/documentation-api` (Porta 3405)
- **TP Capital API** — pacote em `clients/typescript/tp-capital-api` (Porta 4005)

### Python Clients

Python clients with sync/async support and type hints:

- **Workspace API** — pacote em `clients/python/workspace-api-client` (Porta 3200)
- **Documentation API** — pacote em `clients/python/documentation-api-client` (Porta 3405)
- **TP Capital API** — pacote em `clients/python/tp-capital-api-client` (Porta 4005)
...
```
workspace-api/
├── WorkspaceApiClient.ts    # Main client class
├── index.ts                   # Barrel exports
├── core/                      # HTTP infrastructure
│   ├── ApiError.ts           # Error handling
│   ├── BaseHttpRequest.ts    # Base HTTP client
│   ├── CancelablePromise.ts  # Request cancellation
│   └── OpenAPI.ts            # Configuration
├── models/                    # TypeScript types
│   ├── WorkspaceItem.ts
│   ├── WorkspaceCategory.ts
│   └── ...
