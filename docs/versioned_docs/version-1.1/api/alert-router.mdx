...
GITHUB_TOKEN=REDACTED_GITHUB_PAT      # GitHub personal access token
...
- **[Monitoring Overview](/tools/monitoring/overview)** - Prometheus, Alertmanager, Grafana
