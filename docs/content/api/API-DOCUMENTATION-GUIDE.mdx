...
domain: api
type: guide
summary: "Comprehensive guide to TradingSystem REST APIs with authentication, versioning, error handling, and best practices"
status: active
...
| **Service Launcher** | 3500 | `/api/status` | ❌ Host | Health orchestration |
...
**See:** [DEBT-006: No API Versioning Strategy](../governance/planning/TECHNICAL-DEBT-TRACKER.md#debt-006-no-api-versioning-strategy)
...
**See:** [Technical Debt Tracker - DEBT-004: Limited Test Coverage](../governance/planning/TECHNICAL-DEBT-TRACKER.md#debt-004-limited-test-coverage-30)
...
- [Technical Debt Tracker](../governance/planning/TECHNICAL-DEBT-TRACKER.md)
