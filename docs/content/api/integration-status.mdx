...
> Veja **[Containerization](/reference/architecture/containerization)** para detalhes sobre a estratégia de migração de serviços locais para containers.
>
...
| **Docusaurus** | 3400 | Docusaurus v3 | ✅ Running | `http://localhost:3400` |
| **Documentation API** | 3401 | Express + FlexSearch | ✅ Running | `http://localhost:3401` |
...
| Port | Service | Purpose | Status |
|------|---------|---------|--------|
| 3400 | Docusaurus v3 | Documentation site | ✅ Running |
