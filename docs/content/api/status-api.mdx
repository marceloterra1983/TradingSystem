...
- **[Health Check Script](/tools/monitoring/health-check-all)** - Comprehensive health check bash script
- **[Service Manifest](/reference/architecture/services-manifest)** - Service configuration
- **[Dashboard Integration](/frontend/features/service-status)** - Frontend integration guide
- **[Prometheus Setup](/tools/monitoring/prometheus)** - Metrics scraping configuration
