...
slug: /tools/monitoring/health-checks-guide
sidebar_position: 1
...
**Workflow:** [`.github/workflows/health-check.yml`](https://github.com/marceloterra1983/TradingSystem/blob/main/docs/.github/workflows/health-check.yml)
