...
<!-- AUTO-GENERATED SECTIONS by docs:auto - DO NOT EDIT MANUALLY -->
<!-- AUTO-GENERATED SECTIONS by docs:auto - DO NOT EDIT MANUALLY -->
<!-- Last generated: 2025-11-04T14:10:28.618Z -->
...
> 📌 **docs é a fonte primária de documentação.** A tabela abaixo reflete o corte definitivo para o container de documentação (Docusaurus em `3400`, DocsAPI em `3401`). O mapeamento legado (`docs_legacy/context/ops/service-port-map.md`) permanece apenas como referência histórica.
...
| Documentation API | - (npm dev server) | 3401 | http://localhost:3401 | API de documentação (Express + FlexSearch) |
| Documentation Hub (docs) | - (npm dev server) | 3400 | http://localhost:3400 | Hub de documentação (Docusaurus v3 — primário) |
| Documentação (Docusaurus v2 - Legacy) | docs-docusaurus | N/A | N/A | Hub de documentação legado (desativação em andamento) |
...
| Kestra Orchestrator | tools-kestra | 8180 | http://localhost:8180 (management: 8685) | Orquestração de pipelines (start: `tools/kestra/scripts/run.sh`) |
...
| 3400 | Documentation Hub (docs) | Documentation | Active |
| 3401 | Documentation API | Backend API | Active |
...
| Documentation API | `http://localhost:3401/health> | `{"status": "ok"}` |
| Documentation Hub (docs) | `http://localhost:3400` | Page loads |
| Docusaurus v2 (Legacy) | *(retired)* | Page loads (legacy – requires manual override) |
...
curl -f http://localhost:3200/health > /dev/null 2>&1 && echo "✅ TP Capital API" || echo "❌ TP Capital API"
curl -f http://localhost:3401/health > /dev/null 2>&1 && echo "✅ Documentation API" || echo "❌ Documentation API"
curl -f http://localhost:3400 > /dev/null 2>&1 && echo "✅ Documentation Hub (docs)" || echo "❌ Documentation Hub (docs)"
# Legacy Docusaurus endpoint retired (previously served on port 3004)
