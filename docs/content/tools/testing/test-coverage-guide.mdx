...
|--------|-----------|---------|--------|
| Branches | 50% | 59.42% | ✅ Passing |
| Functions | 30% | ~10% | ⚠️ Below Target |
| Lines | 30% | ~10% | ⚠️ Below Target |
| Statements | 30% | 10.02% | ⚠️ Below Target |
...
```
TradingSystem/
├── frontend/dashboard/          # Frontend tests (Vitest)
│   ├── src/__tests__/          # Test files
│   ├── coverage/               # Coverage reports
│   └── vitest.config.ts        # Vitest configuration
│
├── backend/api/workspace/      # Backend tests (Node.js)
│   ├── tests/                  # Test files
│   └── coverage/               # Coverage reports
│
├── apps/tp-capital/            # TP Capital tests
│   └── tests/
│
├── tools/llamaindex/           # Python tests (pytest)
│   ├── tests/
...
|-------|---------|--------|
| 🟢 **Green** | &gt;75% covered | ✅ Good coverage |
| 🟡 **Yellow** | 50-75% covered | ⚠️ Needs improvement |
| 🔴 **Red** | &lt;50% covered | ❌ Priority for testing |
...
| Phase | Target | Status |
|-------|--------|--------|
| Phase 1 (Current) | 30% lines, 50% branches | ⏳ In Progress |
| Phase 2 | 75% global coverage | 🎯 Next |
| Final Target | 85% critical modules | 🏁 Future |
```
