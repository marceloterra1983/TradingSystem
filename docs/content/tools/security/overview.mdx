...
**Implementation**: [`backend/shared/middleware/inter-service-auth.js`](https://github.com/marceloterra1983/TradingSystem/blob/main/docs/backend/shared/middleware/inter-service-auth.js)
...
**Implementation**: [`backend/shared/middleware/advanced-rate-limit.js`](https://github.com/marceloterra1983/TradingSystem/blob/main/docs/backend/shared/middleware/advanced-rate-limit.js)
...
**Implementation**: [`backend/shared/middleware/index.js`](https://github.com/marceloterra1983/TradingSystem/blob/main/docs/backend/shared/middleware/index.js)
...
**Configuration**: [`.zap/rules.tsv`](https://github.com/marceloterra1983/TradingSystem/blob/main/docs/.zap/rules.tsv)
...
**Workflow**: [`.github/workflows/security-scan.yml`](https://github.com/marceloterra1983/TradingSystem/blob/main/docs/.github/workflows/security-scan.yml)
...
- **Documentation**: See [docs/content/tools/security/](https://github.com/marceloterra1983/TradingSystem/blob/main/docs/content/tools/security)
