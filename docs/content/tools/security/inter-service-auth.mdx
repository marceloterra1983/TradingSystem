...
slug: /tools/security/inter-service-auth
sidebar_position: 2
...
See [`backend/shared/middleware/inter-service-auth.js`](https://github.com/marceloterra1983/TradingSystem/blob/main/docs/backend/shared/middleware/inter-service-auth.js) for complete API documentation.
