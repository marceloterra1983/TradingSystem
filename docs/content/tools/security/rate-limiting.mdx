...
slug: /tools/security/rate-limiting
sidebar_position: 3
...
See [`backend/shared/middleware/advanced-rate-limit.js`](https://github.com/marceloterra1983/TradingSystem/blob/main/docs/backend/shared/middleware/advanced-rate-limit.js) for complete API documentation.
