...
slug: /tools/security/dependency-management-guide
sidebar_position: 3
...
Status: ✅ Approved for auto-merge
Reason: ✅ Patch update (non-breaking)
```
...
Reason: ⚠️ Major version update requires manual review
```
...
**Location:** GitHub → Security → Dependabot alerts
...
# 4. Check for errors
# GitHub → Security → Dependabot alerts → View logs
```
...
- ✅ 90%+ security patches auto-merged
- ✅ Average dependency age < 3 months
- ✅ 100% of dependencies monitored
- ✅ Weekly automated checks running
