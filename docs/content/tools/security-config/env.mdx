...
The project uses **5 levels** of environment configuration, loaded by [`backend/shared/config/load-env.js`](https://github.com/marceloterra1983/TradingSystem/blob/main/backend/shared/config/load-env.js):
