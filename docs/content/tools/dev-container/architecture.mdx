...
domain: tools
type: architecture
summary: "Arquitetura detalhada do Dev Container: camadas, redes, volumes, processos e comunicação com Docker host"
status: active
...
![Dev Container Architecture](../../diagrams/rendered/tools/dev-container-architecture.png)

**Diagrama Fonte:** [dev-container-architecture.puml](../../diagrams/source/tools/dev-container-architecture.puml)
...
![Dev Container Network](../../diagrams/rendered/tools/dev-container-network.png)

**Diagrama Fonte:** [dev-container-network.puml](../../diagrams/source/tools/dev-container-network.puml)
...
- **[devcontainer.json](../../../../.devcontainer/devcontainer.json)** - Configuração
- **[Dockerfile](../../../../.devcontainer/Dockerfile)** - Image build
