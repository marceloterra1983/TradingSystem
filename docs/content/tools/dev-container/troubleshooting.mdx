...
domain: tools
type: guide
summary: "Guia de troubleshooting do Dev Container: problemas comuns, diagnóstico, soluções e quando rebuild vs restart"
status: active
...
| API Indisponível | Dashboard can't reach API | Fix Vite proxy config | [#5](#issue-5-api-indisponível) |
...
**⚠️ WARNING: Deletes all data! Commit code first!**
...
# VS Code → Ctrl+Shift+P → "Dev Containers: Rebuild Container (No Cache)"
...
- **[Overview](./overview.mdx)** - Visão geral
