...
**Configuration**: Controlled via environment variables (see [Variables](variables.mdx))
...
- [Prompt Style Guide](style-guide.mdx) - Tone and formatting guidelines
- [Prompt Variables](variables.mdx) - Environment variables and configuration
