...
**Scope**: Applies to all LLM-powered features (LlamaIndex pipelines, Ollama prompts)
...
- **MCPGuild**: Prompt templates for ingestion/query automations
- **Backend Guild**: API contracts & RAG integrations
- **Product**: Business requirements and success criteria

**Review Cadence**:

- Quarterly review of all production prompts
- Update when LLM models change (GPT-4 → GPT-4o)
...
- [Prompt Patterns](patterns.mdx) - Reusable templates
- [Prompt Variables](variables.mdx) - Environment configuration
