...
**Example Usage**: Use this template for ADRs like "ADR-0001: Use LowDB for MVP Storage", "ADR-0002: Adopt Agno Framework for Agents", "ADR-0003: Choose TimescaleDB over PostgreSQL".
