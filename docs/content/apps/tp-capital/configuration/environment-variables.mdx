...
- ✅ **No VITE_ prefix for proxy targets** - Server-side only (see [PROXY-BEST-PRACTICES.md](docs/content/frontend/engineering/PROXY-BEST-PRACTICES.md))
...
- **Network Diagram**: [TP Capital Network Architecture](/docs/assets/diagrams/source/apps/tp-capital-network-architecture.puml)
- **Proxy Best Practices**: [PROXY-BEST-PRACTICES.md](/docs/content/frontend/engineering/PROXY-BEST-PRACTICES.md)
