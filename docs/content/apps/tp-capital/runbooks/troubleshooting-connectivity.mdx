...
**See Full Architecture**: [ADR 007 - TP Capital API Gateway Integration](/docs/reference/adrs/007-tp-capital-api-gateway-integration)
...
**Note**: PgBouncer currently disabled due to SCRAM-SHA-256 authentication issues (see [tp-capital-network-architecture.puml](docs/content/assets/diagrams/source/apps/tp-capital-network-architecture.puml) line 139)
