---
title: Guia de Migração para Stack Autônoma
sidebar_position: 10
description: Guia completo para migrar TP-Capital de banco compartilhado para stack autônoma
tags:
  - apps
  - tp-capital
  - migration
...
# TP-Capital: Migração para Stack Autônoma

## 🎯 Visão Geral

Este guia documenta a migração do **TP-Capital** de uma arquitetura com banco de dados compartilhado para uma **stack autônoma** com 5 containers dedicados.

### Motivação

**Problema atual:**
- TP-Capital compartilha TimescaleDB central (`tradingsystem` database, `tp_capital` schema)
- Contenção de recursos com outros serviços
...
### 1. ADR Completo
**Localização:** [`docs/content/reference/adrs/008-tp-capital-autonomous-stack.md`](../../reference/adrs/008-tp-capital-autonomous-stack.md)

Análise arquitetural detalhada incluindo:
- 6 dimensões de análise (estrutura, design patterns, dependências, data flow, escalabilidade, segurança)
...
### 5. PostgreSQL Config
**Localização:** `tools/compose/tp-capital/postgresql.conf`
...
# Migração real (com backup automático)
...
# - 90% tráfego → nova stack (porta 4005)
# - 10% tráfego → stack antiga (porta 4006)
...
### Após 1 Semana (Cleanup)
- [ ] Validar estabilidade
- [ ] Documentar lessons learned
- [ ] Limpar schema antigo:

```sql
-- CAUTION: Apenas após 1 semana de estabilidade!
...
- [ADR-008: TP-Capital Autonomous Stack](../../reference/adrs/008-tp-capital-autonomous-stack.md)
- [Architecture Review (2025-11-04)](../../../ARCHITECTURE-REVIEW-TP-CAPITAL-2025-11-04.md)
...
3. Consultar ADR-008: Análise arquitetural completa
4. Executar rollback: Seguir instruções acima
