...
slug: /apps/tp-capital/deployment
sidebar_position: 6
...
5. **Optional – Start Telegram Gateway Stack**

   ```bash
   bash tools/scripts/start-local-telegram-gateway.sh
   # Boots TimescaleDB, Gateway (4007/4010) and TP Capital API
   ```
...
4. **Verify Deployment**
   ...
   curl http://<host>:4007/health    # Telegram Gateway
