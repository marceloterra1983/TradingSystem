...
slug: /apps/tp-capital/architecture/complete-stack-guide
...
- **[Troubleshooting Guide](../runbooks/troubleshooting-connectivity.mdx)** - Complete runbook with all common issues
- **[Environment Variables](../configuration/environment-variables.mdx)** - Configuration reference
...
- **[Environment Variables](../configuration/environment-variables.mdx)** - Complete reference
- **[Troubleshooting Guide](../runbooks/troubleshooting-connectivity.mdx)** - Operational runbook
- **[Port Registry](https://github.com/marceloterra1983/TradingSystem/blob/main/docs/content/apps/tools/ports-services)** - Port allocation table
- **[PROXY-BEST-PRACTICES](../../../frontend/engineering/PROXY-BEST-PRACTICES.md)** - Vite proxy guide
