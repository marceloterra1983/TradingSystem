...
- **[ADR 007](/docs/reference/adrs/007-tp-capital-api-gateway-integration)** - Architectural decisions
...
- **[ADR 007 - TP Capital API Gateway Integration](/docs/reference/adrs/007-tp-capital-api-gateway-integration)** - Architectural decision record
- **[Network Architecture Diagram](/docs/assets/diagrams/source/apps/tp-capital-network-architecture.puml)** - PlantUML diagram
- **[Request Flow Diagram](/docs/assets/diagrams/source/apps/tp-capital-api-gateway-flow.puml)** - Sequence diagram
...
- **[Port Registry](/docs/tools/ports-services)** - Port allocation table
- **[PROXY-BEST-PRACTICES](/docs/content/frontend/engineering/PROXY-BEST-PRACTICES.md)** - Vite proxy guide
