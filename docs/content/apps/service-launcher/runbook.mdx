...
echo "CORS_ORIGIN=http://localhost:3103,http://localhost:3205" >> .env
docker restart service-launcher
```
...
CORS_ORIGIN=https://localhost:3103,https://localhost:3205
```
...
CORS_ORIGIN=http://localhost:3104,http://localhost:3205
```
