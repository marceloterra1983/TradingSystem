...
slug: /apps/telegram-gateway/overview
sidebar_position: 1
...
- **MTProto Gateway (apps/telegram-gateway, port 4007)** authenticates with Telegram, captures channel messages, and writes them to TimescaleDB queue tables (`telegram_gateway.messages`).
