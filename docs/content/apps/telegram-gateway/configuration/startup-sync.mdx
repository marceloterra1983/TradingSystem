...
- [Guia de Operações](../operations) — arquitetura dos serviços (MessageSyncService, TelegramClientService)
- [Visão Geral do Gateway](../overview) — canais monitorados e dependências
