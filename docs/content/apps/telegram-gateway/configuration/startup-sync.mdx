---
title: 'Sincronização Automática no Startup'
slug: /apps/telegram-gateway/configuration/startup-sync
sidebar_position: 3
tags: ['telegram-gateway', 'configuration', 'sync']
domain: backend
owner: BackendGuild
type: guide
summary: Automatic synchronization of monitored channels on Telegram Gateway startup
description: Automatic synchronization of monitored channels on Telegram Gateway startup
status: active
...
- [Guia de Operações](../operations.mdx) — arquitetura dos serviços (MessageSyncService, TelegramClientService)
- [Visão Geral do Gateway](../overview.mdx) — canais monitorados e dependências
- [Troubleshooting Geral](../../../tools/troubleshooting/telegram-gateway-sync.mdx)
