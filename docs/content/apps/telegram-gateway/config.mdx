---
title: Configuration
slug: /apps/telegram-gateway/config
sidebar_position: 5
...
|----------|-------------|---------|
| `GATEWAY_PORT` | HTTP port for health/metrics endpoints | `4007` |
...
|---------|------|-------------|
| Gateway Service | 4007 | Health/metrics, local management |
...
1. Run Gateway locally: `npm install && npm start` (responds on `http://localhost:4007/health`).
