...
slug: /apps/telegram-gateway/redis-cache-guide
sidebar_position: 12
...
**Complete documentation:** [redis-schema.md](https://github.com/marceloterra1983/TradingSystem/blob/main/apps/telegram-gateway/src/cache/redis-schema.md)
...
# Edit docker-compose.4-2-telegram-stack.yml: maxmemory 2gb
...
**Related:**
- [Redis Schema Documentation](https://github.com/marceloterra1983/TradingSystem/blob/main/apps/telegram-gateway/src/cache/redis-schema.md)
