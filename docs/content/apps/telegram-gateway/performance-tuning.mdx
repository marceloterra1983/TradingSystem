...
- ⚠️ Consider adding read replica

#### At 50 msg/s (100% capacity):
- 🔴 Scale Redis (2GB memory)
- 🔴 Scale TimescaleDB (4 CPU, 4GB)
- 🔴 Add read replica for analytics

#### At 60+ msg/s (overload):
- 🔴 Add RabbitMQ queue (mandatory)
- 🔴 Horizontal scaling (multiple workers)
- 🔴 Consider sharding by channel
...
**Gain:** ↓ 95% analytics queries (3s → 50ms)
...
**Gain:** ↑ 30% initial hit rate

---

**Related:**
- [Monitoring Guide](./monitoring-guide.mdx)
- [Redis Cache Schema](../../../apps/telegram-gateway/src/cache/redis-schema.md)
