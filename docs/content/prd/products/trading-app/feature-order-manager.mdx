...
slug: /prd/products/trading-app/feature-order-manager
...
- [Order Schema](../../../sdd/domain/schemas/v1/order.mdx) - Order entity definition
- [Risk Rule Schema](../../../sdd/domain/schemas/v1/risk-rule.mdx) - Risk limit configuration
- [Order Created Event](../../../sdd/events/v1/order-created.mdx) - Event payload contract
- [Place Order Flow](../../../sdd/flows/v1/place-order.mdx) - Order placement sequence
- [Cancel Order Flow](../../../sdd/flows/v1/cancel-order.mdx) - Order cancellation sequence

**API**

- [Order Manager API](../../../api/order-manager.mdx) - API summary
- [Order Manager Spec](../../../sdd/api/order-manager/v1/spec.mdx) - Detailed API specification
- [Order Manager Guidelines](../../../sdd/api/order-manager/v1/guidelines.mdx) - API conventions
- Redoc: `/redoc/order-manager` (TODO - automated build pending)

**Frontend**

- [Frontend Architecture](../../../frontend/engineering/architecture.mdx) - React Router, Zustand, React Query
- [Frontend Conventions](../../../frontend/engineering/conventions.mdx) - Component structure, imports
- [Design System](../../../frontend/design-system/components.mdx) - UI components
...
- [Trading App Overview](prd-overview.mdx)
- [Order Manager API](../../../api/order-manager.mdx)
- [Order Schema](../../../sdd/domain/schemas/v1/order.mdx)
- [Place Order Flow](../../../sdd/flows/v1/place-order.mdx)
