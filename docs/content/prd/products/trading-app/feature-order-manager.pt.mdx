...
slug: /prd/products/trading-app/feature-order-manager.pt
...
- [Schema de Ordem](../../../sdd/domain/schemas/v1/order.mdx)
- [Schema de Regra de Risco](../../../sdd/domain/schemas/v1/risk-rule.mdx)
- [Evento Order Created](../../../sdd/events/v1/order-created.mdx)
- [Fluxo Place Order](../../../sdd/flows/v1/place-order.mdx)
- [Fluxo Cancel Order](../../../sdd/flows/v1/cancel-order.mdx)

**API**

- [API Order Manager](../../../api/order-manager.mdx)
- [Spec Order Manager](../../../sdd/api/order-manager/v1/spec.mdx)
- [Guidelines Order Manager](../../../sdd/api/order-manager/v1/guidelines.mdx)
- Redoc: `/redoc/order-manager` (pendente de automação)

**Frontend**

- [Arquitetura Frontend](../../../frontend/engineering/architecture.mdx)
- [Convenções Frontend](../../../frontend/engineering/conventions.mdx)
- [Design System](../../../frontend/design-system/components.mdx)
...
- [Schema de Ordem](../../../sdd/domain/schemas/v1/order.mdx)
- [Fluxo Place Order](../../../sdd/flows/v1/place-order.mdx)
- [Configuração de Limites de Risco](../../../tools/security-config/risk-limits.mdx)
