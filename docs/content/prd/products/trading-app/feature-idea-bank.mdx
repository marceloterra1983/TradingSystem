...
slug: /prd/products/trading-app/feature-idea-bank
...
- [Workspace App Overview](../../../apps/workspace/overview.mdx)
- [Database Schema](../../../database/schema.mdx) - Idea Bank tables
- [Frontend Architecture](../../../frontend/engineering/architecture.mdx)
...
- [Workspace App](../../../apps/workspace/overview.mdx)
- [Workspace API](https://github.com/marceloterra1983/TradingSystem/blob/main/docs/api/workspace-api) (when migrated)
- [Database Schema](https://github.com/marceloterra1983/TradingSystem/blob/main/docs/database/schema)
