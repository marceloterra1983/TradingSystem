...
- **QuestDB**: Time-series data for TP Capital signals, Telegram metadata, and RAG metrics.
...
- [Database Overview](overview.mdx) – Architecture and data stores.  
- [Schema Reference](schema.mdx) – Detailed table definitions.  
- [Retention & Backup](retention-backup.mdx) – Retention schedules and backup runbooks.  
