...
**See**: `governance/ci-cd-integration` for complete CI/CD documentation, workflow details, troubleshooting, and setup instructions.

---

## Related Documentation

- [CI/CD Integration](./ci-cd-integration) - Automated validation workflows
...
- Migration Report (`governance/migration/INVENTORY-REPORT.md`) - Executive summary (arquivo interno)
