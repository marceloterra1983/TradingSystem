...
- [CI/CD Integration](./ci-cd-integration.mdx) - Automated validation workflows
- [Review Checklist](./review-checklist.mdx) - Chapter-by-chapter review
- [Maintenance Checklist](./maintenance-checklist.mdx) - Quarterly hygiene
- [Communication Plan](./communication-plan.mdx) - Internal announcements
