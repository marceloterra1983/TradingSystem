...
sidebar_label: Technical Debt Tracker
sidebar_position: 10
---
...
**Source:** [Architecture Review 2025-11-01](https://github.com/marceloterra1983/TradingSystem/blob/main/governance/reviews/architecture-2025-11-01/index.md)
...
**ADR:** [ADR-003: API Gateway Implementation](../reference/adrs/ADR-003-api-gateway-implementation)
...
- CLAUDE.md (raiz do repositório) — seção “Architecture & Quality Guidelines”
