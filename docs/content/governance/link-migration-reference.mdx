...
sidebar_label: Link Migration Reference
sidebar_position: 20
---
...
- Internal: `[Architecture](https://github.com/marceloterra1983/TradingSystem/blob/main/docs/content/governance/architecture)`
- Absolute: `[Docs Hub](http://localhost:3400)`
- Legacy (temporary): `[Legacy Guide](https://github.com/marceloterra1983/TradingSystem/blob/main/docs/context/backend/data/guides/database-ui-tools.md) (archived)`
