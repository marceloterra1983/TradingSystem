...
description: Plano de comunicação para stakeholders com updates bi-semanais,
  status reports e canais de comunicação.
slug: /governance/strategy/communication-plan
tags:
  - communication
  - stakeholders
  - governance
