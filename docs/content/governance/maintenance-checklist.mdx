...
**Command**:
```bash
# Scan docs for outdated content (above 90 days)
...
**Actions**:
- [ ] Review outdated documents list (above 90 days since lastReviewed)
...
- Files by review window (under 30, 31-90, above 90 days)
...
| Content freshness (under 90 days) | above 80% | - | - | - | - |
| Link validity | >95% | - | - | - | - |
