...
**Triggered By**: [Incident 2025-11-05](/governance/evidence/incidents/2025-11-05-tp-capital-connectivity-failure)
...
- Main Policy: [POL-0002: Secrets & Environment Variables](/governance/policies/secrets-env-policy)
