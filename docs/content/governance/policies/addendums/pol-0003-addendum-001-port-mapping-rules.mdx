...
description: Regras mandatórias de mapeamento de portas e comunicação entre containers.
tags: [policy, addendum, docker, networking, ports]
owner: PlatformEngineering
lastReviewed: "2025-11-05"
slug: /governance/policies/addendums/pol-0003-addendum-001-port-mapping-rules
---
...
**Triggered By**: [Incident Report 2025-11-05](https://github.com/marceloterra1983/TradingSystem/blob/main/governance/evidence/incidents/2025-11-05-tp-capital-connectivity-failure.md)
...
- Main Policy: [POL-0003: Container Infrastructure Policy](https://github.com/marceloterra1983/TradingSystem/blob/main/governance/policies/container-infrastructure-policy.md)
