...
- [VERSIONING-AUTOMATION.md](./versioning-automation.mdx) - Automated workflow documentation
...
> See [VERSIONING-AUTOMATION.md](./versioning-automation.mdx) for automated workflow.
...
- [VALIDATION-GUIDE.md](./validation-guide.mdx) - Validation procedures (includes version validation)
- [VERSIONING-AUTOMATION.md](./versioning-automation.mdx) - Automated versioning workflow
- [MAINTENANCE-CHECKLIST.md](./maintenance-checklist.mdx) - Quarterly maintenance tasks
- [COMMUNICATION-PLAN.md](./communication-plan.mdx) - Announcement templates
