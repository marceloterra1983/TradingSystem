...
Definir requisitos técnicos **testáveis e verificáveis** para implementação da [POL-0002 - Política de Gerenciamento de Segredos](../policies/secrets-env-policy.mdx).
...
- **Política:** [POL-0002 - Secrets & Env Policy](../policies/secrets-env-policy.mdx)
- **SOP:** [Secrets Rotation SOP](../controls/secrets-rotation-sop.mdx)
