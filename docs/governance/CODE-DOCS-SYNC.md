...
- Location: `docs/governance/CODE-DOCS-MAPPING.json`
...
1. Edit `docs/governance/CODE-DOCS-MAPPING.json`
...
- See `docs/governance/CODE-DOCS-MAPPING.json` for authoritative list.
