...
tags: [service-launcher, api, health, orchestration, nodejs, express]
domain: backend
type: service
...
```json
{
  ...
  "workingDir": "/home/marce/projetos/TradingSystem/frontend/apps/dashboard",
  "command": "npm run dev"
}
```
...
Todas as variáveis são **opcionais** - o serviço tem defaults razoáveis.
...
```typescript
// frontend/apps/dashboard/src/components/pages/ConnectionsPage.tsx
