...
// SERVICE_LAUNCHER_PORT takes priority, then PORT for backward compatibility
const PORT = Number(process.env.SERVICE_LAUNCHER_PORT || process.env.PORT || 3500);
const preferWindowsTerminal = process.env.SERVICE_LAUNCHER_USE_WT === 'true';
const defaultProtocol = process.env.SERVICE_LAUNCHER_PROTOCOL || 'http';
const defaultHost = process.env.SERVICE_LAUNCHER_HOST || 'localhost';
