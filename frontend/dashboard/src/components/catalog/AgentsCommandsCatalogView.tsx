...
// Extract agents array from JSON
...
export default function AgentsCommandsCatalogView({
  ...
  const [typeFilter, setTypeFilter] = useState<"all" | "agent" | "command">(
    "all",
  );
          ...
          >
            <CollapsibleCardHeader>
              <div className="flex items-center gap-3">
                <CollapsibleCardTitle>
                  Catálogo Unificado - Agents & Commands
                </CollapsibleCardTitle>
              ...
              <CollapsibleCardDescription>
                Consulte o diretório unificado de agentes e comandos
                configurados para o TradingSystem, com filtros por tipo,
                domínio, tags e acesso rápido ao arquivo Markdown original.
              </CollapsibleCardDescription>
            </CollapsibleCardHeader>
            <CollapsibleCardContent>
