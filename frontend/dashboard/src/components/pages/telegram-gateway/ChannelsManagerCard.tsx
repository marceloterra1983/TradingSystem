...
import { PlusCircle, Save, ToggleLeft, ToggleRight, Trash2 } from 'lucide-react';
...
export function ChannelsManagerCard() {
  ...
  return (
    <CollapsibleCard cardId="telegram-gateway-channels">
      <CollapsibleCardHeader>
        <CollapsibleCardTitle>
          <PlusCircle className="mr-2 inline-block h-5 w-5 text-purple-500" />
          Canais monitorados
        </CollapsibleCardTitle>
        <CollapsibleCardDescription>
          Registre os canais Telegram autorizados para coleta. Quando houver canais ativos, somente eles
          serão processados.
        </CollapsibleCardDescription>
      </CollapsibleCardHeader>
      <CollapsibleCardContent>
            ...
            <table className="w-full min-w-[720px] text-left text-sm">
              ...
              <tbody className="divide-y divide-slate-200 dark:divide-slate-800">
                {isLoading ? (
                  ...
                  <tr>
                    <td colSpan={5} className="px-3 py-6 text-center text-slate-500 dark:text-slate-400">
                      Nenhum canal cadastrado. Enquanto a lista estiver vazia, o gateway processará todos
                      os canais recebidos.
                    </td>
                  </tr>
                ) : (
