    ...
    <div className="space-y-4">
      ...
      <div className="prose dark:prose-invert max-w-none">
        <p className="text-slate-700 dark:text-slate-300">
          O <strong>TradingSystem</strong> é uma plataforma integrada de
          negociação que combina análise de mercado, gestão de risco, execução
          automatizada e monitoramento em tempo real.
        </p>
        <p className="text-slate-700 dark:text-slate-300">
          A arquitetura é baseada em microserviços com APIs REST, processamento
          de eventos em tempo real, armazenamento otimizado para séries
          temporais e interfaces de usuário modernas.
        </p>
      </div>
    </div>
  );
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="rounded-lg border border-slate-200 dark:border-slate-700 p-4 bg-white dark:bg-slate-800">
          ...
          <p className="text-sm text-slate-600 dark:text-slate-400">
            React + Vite, TailwindCSS, TanStack Query, Recharts para
            visualizações
          </p>
        </div>
        <div className="rounded-lg border border-slate-200 dark:border-slate-700 p-4 bg-white dark:bg-slate-800">
