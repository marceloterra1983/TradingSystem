...
import { AlertCircle, RefreshCcw, Info, ChevronDown, ChevronRight } from "lucide-react";
        ...
        <div className="space-y-1.5">
                ...
                <div className="flex items-start gap-2 px-3 py-2">
                  ...
                  <div className="flex items-center gap-1.5 flex-shrink-0">
                    ...
                    <span className={`text-[10px] font-bold uppercase tracking-wide ${
                      ...
                      log.level === 'debug' ? 'text-slate-500 dark:text-slate-400' :
          ...
          {logs.length === 0 && (
            <div className="rounded border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-950 p-8 text-center">
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400">Nenhum log encontrado</p>
            </div>
          )}
        </div>
