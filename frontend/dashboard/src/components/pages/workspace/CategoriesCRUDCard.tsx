...
import { Plus, Pencil, Trash2, X, Check, Folder, AlertCircle, RefreshCw, Clock } from 'lucide-react';
import { Button } from '../../ui/button';
import { cn } from '../../../lib/utils';
import { categoriesService, Category, CreateCategoryDTO } from '../../../services/categoriesService';
...
export default function CategoriesCRUDCard() {
  ...
  const handleCreate = async () => {
    ...
    try {
      setError(null);
      setSyncing(true);
      await categoriesService.createCategory(formData as CreateCategoryDTO);
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button
          ...
          disabled={usingFallbackData || isCreating}
      ...
      {isCreating && (
        <div className="bg-blue-50 dark:bg-blue-950 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
          <div className="flex items-center justify-between mb-3">
            <h4 className="text-sm font-semibold text-blue-800 dark:text-blue-200">Nova Categoria</h4>
            <button
              onClick={cancelEdit}
          ...
          <div className="grid grid-cols-2 gap-3 mb-3">
            <input
              ...
              className="px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500"
              pattern="[a-z0-9-]+"
            />
        ...
        <table className="min-w-full divide-y divide-gray-200 text-sm dark:divide-gray-800">
          <thead className="bg-gray-50 dark:bg-gray-900/60">
            <tr>
              ...
              <th className="px-4 py-2 text-left font-medium text-gray-500 dark:text-gray-400">Descrição</th>
