...
console.log('🔍 Reading source file:', SRC_FILE);
...
console.log(`✓ Found ${agentsArray.length} agents in source file`);
...
console.log(`✅ Generated metadata file: ${OUT_FILE}`);
console.log(`📦 Metadata size: ${(metadataSize / 1024).toFixed(1)} KB`);
console.log(`🎯 Bundle size reduction: ~${savings}%`);
