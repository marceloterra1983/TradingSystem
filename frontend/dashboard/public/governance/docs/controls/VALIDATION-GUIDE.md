...
- [CI/CD Integration](/governance/ci-cd-integration) - Automated validation workflows
- [Review Checklist](/governance/review-checklist) - Chapter-by-chapter review
- [Maintenance Checklist](/governance/maintenance-checklist) - Quarterly hygiene
- [Communication Plan](/governance/communication-plan) - Internal announcements
- Migration Report (`governance/migration/INVENTORY-REPORT.md`) - Executive summary
- [docs README](/governance) - Automation and helpers
