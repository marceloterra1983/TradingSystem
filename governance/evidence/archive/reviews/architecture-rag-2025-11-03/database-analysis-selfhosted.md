...
## 🔧 Neon Open Source: Setup Guide (removido)

> **Atualização – 11 nov 2025**  
> O compose `tools/compose/docker-compose.neon.yml` e os scripts associados foram removidos do repositório.  
> Utilize a stack `tools/compose/docker-compose.4-3-workspace-stack.yml` para ambientes locais e consulte a documentação atualizada.
